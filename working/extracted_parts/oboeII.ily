\version "2.19.83"
% automatically converted by musicxml2ly from oboeII.xml
\pointAndClickOff
...
PartPOneVoiceOne =  \relative ef'' {
    ...
    f2 -- r2 | % 49
    s1*3 | % 52
    r2 r4 r8. bf'16 -\mf | % 53
    bf2 ( -\> f4 ) r8. -\! bf16 | % 54
    bf2 ( -\> f4 ) r4 -\! | % 55
    bf2 ( cf2 | % 56
    gf4. ) r8 r2 | % 57
    R1 | % 58
    r2 r4 df,8. ( -\f -\< df'16 ) -\! | % 59
    cs4 ( -> fs,8 ) r8 r4 fs8. ( -\< fs'16 ) -\! | \barNumberCheck #60
    fs4 ( -> fs,8 ) r8 r4 d'8. ( -\< d'16 ) -\! | % 61
    d4 ( -> d,8 ) r8 r4 b8. ( -\< b'16 ) -\! | % 62
    b4 ( -> b,8 ) r8 r4 c4 ( -> | % 63
    c,8 ) r8 r4 r4 g'4 ( -\ff | % 64
    ...
    | % 93
    e,1*1/2 ( :32 -\ff b1*1/2 :32 | % 94
    e1*1/2 :32 b1*1/2 ) :32 | % 95
    e1*1/2 ( :32 -\ff b1*1/2 :32 | % 96
    e1*1/2 :32 b1*1/2 ) :32 | % 97
    \once \omit TupletBracket
    \times 2/3  {
    ...
    -\! | % 98
    ef,1 -\markup{ \bold\small\italic {ffz} } | % 99
    R1 | \barNumberCheck #100
    \times 2/3  {
        af,8*255/256 -! af8*255/256 -! r8*129/128 }
    r4 r2 | % 101
    s1*9 | \barNumberCheck #110
    a4.. ( -\markup{ \bold\small\italic {pp espr.} } b16 cs2 ~ -\< | % 111
    cs4.. d16 -\! -\> cs2 ) -\! | % 112
    s1*4 | % 116
    a4.. ( -\p b16 cs2 ~ | % 117
    cs2 b2 | % 118
