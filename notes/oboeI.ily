...
oboeINotes = \relative c'' {
  ...
  % 24
  r2 r4 cs4 ( -\markup{ \small\italic {P} } \< |
  ...
  % 93
  gs,1*1/2 ( :32 \ff e1*1/2 :32 |

  % 94
  gR1*1/2 :32 e1*1/2 ) :32 |

  % 95
  gR1*1/2 ( :32 \ff e1*1/2 :32 |
  ...
  % 98
  b8 -\markup{ \bold\small\italic {ffz} } r8 r4 r2 |
  ...
  % 106
  r4 e4. ( \p -\markup{ \bold\small\italic {dolce} } f8 g4 |
