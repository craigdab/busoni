\version "2.19.83"
% automatically converted by musicxml2ly from barisax.xml
\pointAndClickOff
...
PartPOneVoiceOne =  \relative bs' {
    \transposition ef, \clef "treble" \key cs \minor
    \numericTimeSignature\time 4/4 s1*2 | % 3
    s1*10 | % 13
    s1*17 | \barNumberCheck #30
    bs1 ~ -\pp | % 31
    bs1 ~ | % 32
    bs1 | % 33
    bs1 ~ | % 34
    ...
    es4 fs4 ) r4 ds4 ( | % 58
    es8. fs16 g4 ) r2 -\! | % 59
    ds4. ( -\f -\< es8 fs4 ) r4 | \barNumberCheck #60
    ds4. ( es8 g4 ) r4 | % 61
    ds4. ( e8 fs4 ) r4 -\! | % 62
    ds,4. ( es8 fs4 ) r4 | % 63
    r2 a'4 ( -\ff a,8 ) r8 | % 64
    ...
    r2 r4 ef'4 -\f | % 67
    a,4. -> b8 cs2 ~ -\fp | % 68
    cs8 e,8 -\< gs8. cs16 cs8 -\ff -\! r8 r4 | % 69
    s1*3 | % 72
    gs4. as8 b2 ( -> -\fp | % 73
    bs8 ) ds8 -\< gs8. bs16 bs8 -. -\! r8 bs,4 -\mf | % 74
    ds4 ( ds4 es4 fss4 ) | % 75
    ds4 ( ds8. es16 gs4 ) gs4 ( -> | % 76
    ds4 es4 fs4 gs4 ) | % 77
    e4 ( -\< fs8. gs16 a4 ) bf4 ( -\! | % 78
    e,4 fs4 g4 ) b4 ( -\< | % 79
    e,4 fs4 ) -\! b,4. ( -\p -\< g'8 ) -\! | \barNumberCheck #80
    g1 -\f -\< -\! | % 81
    g1 -\ff | % 82
    ef4. -> -\ff f8 g4 ef4 -- | % 83
    bf4. -> c8 df4 bf4 -> | % 84
