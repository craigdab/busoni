\version "2.19.83"
% automatically converted by musicxml2ly from clarinetIII.xml
\pointAndClickOff
...
PartPOneVoiceOne =  \relative a {
    ...
    ef2 -\! -\> d4 ) e4 -\! | % 17
    fs4. ( a8 gs4 ) ds4 ( | % 18
    bs4. cs8 ds4 ) b8. ( -\p cs16 | % 19
    ds4 -\< e4 fs4 gs4 ) | \barNumberCheck #20
    gs4. ( a8 ) a4 r4 -\! | % 21
    R1 | % 22
    ds,4. ( f,8 g4 ) gs8. ( as16 | % 23
    c4 cs4 ds4 f4 ) | % 24
    f4. ( fs8 ) fs4 ds4 ( -\markup{ \small\italic {P} } -\< | % 25
    f4 g4 gs4 as4 ) -\! | % 26
    s1*6 | % 32
    f,2. -\markup{ \bold\small\italic {P} } r4 | % 33
    s1*2 | % 35
    r2 r4 df'4 ( -\pp | % 36
    f,2. ) df'4 ( | % 37
    f,2. ) df'4 ( | % 38
    f,1 ~ | % 39
    f2 ) ~ -\> f8 -\! r8 r4 | \barNumberCheck #40
    r2 r4 e4 ( -\mp | % 41
    fs2 ~ fs8 ) r8 e4 ( | % 42
    fs4 gs4 ~ gs8 ) r8 e8. fs16 -. | % 43
    fs8 -. gs8 -. e8 -. fs8 -. fs8 -. e'8 -. e8 -. d8 -. | % 44
    R1 | % 45
    bs'2 ( -\mf -\> b4 ) -\! r4 | % 46
    bs2 ( -\> b4 ) -\! r4 | % 47
    ds2 ( -\p c2 | % 48
    b4 ) r4 r2 | % 49
    r2 b,2 ~ | \barNumberCheck #50
    b2 cs2 ~ | % 51
    cs2 b2 ~ | % 52
    b4 r4 r2 | % 53
    g'2 ( -\mf -\> c4 ) r4 -\! | % 54
    ...
    | % 62
    df4 ( -> -\! df,8 ) r8 r4 d4 ( | % 63
    d,8 ) r8 r4 r4 g4 ( -\ff | % 64
    ...
    s1*3 | % 72
    r2 af2 ~ -\fp | % 73
    af2 ~ af8 -. r8 es'4 -\mf | % 74
    gs4 ( gs4 as4 bs4 ) | % 75
    gs4 ( gs8. as16 bs4 ) cs4 ( -> | % 76
    gs4 as4 b4 cs4 ) | % 77
    a4 ( -\< b8. cs16 d4 ) ef4 ( -\! | % 78
    a,4 b4 c4 ) e4 ( -\< | % 79
    ...
    r4 r2 | % 101
    s1*15 | % 116
    b'2 ( -\markup{ \small\italic {p`} } as2 | % 117
    gs2 fs2 ) | % 118
    \once \omit TupletBracket
    \times 2/3  {
