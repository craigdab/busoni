\version "2.19.83"
% automatically converted by musicxml2ly from altosax.xml
\pointAndClickOff
...
PartPOneVoiceOne =  \relative a' {
    ...
    s1*10 | % 13
    s1*2 | % 15
    r2 r4 a4 ( -\markup{ \small\italic {P} } | % 16
    b2 a4 r4 ) | % 17
    r2. as4 ( -\markup{ \small\italic {P} } -\< | % 18
    bs2 ds4 -\! -\> d4 | % 19
    cs4 ) r4 -\! r2 | \barNumberCheck #20
    ...
    | % 59
    as4 ( -> -\! ds,8 ) r8 r2 | \barNumberCheck #60
    s1*2 | % 62
    ds,4. ( es8 fs4 ) r4 | % 63
    r2 a'4 ( -\ff a,8 ) r8 | % 64
    e'4 f4 g4 f8. g16 | % 65
    ...
    df,4. -- ef8 -- f4 -- r4 | % 67
    a,4. b8 cs2 ~ | % 68
    cs16 -\< ds16 e16 fs16 gs16 as16 bs16 cs16 cs4 -> -\! cs,4 ( -\ff | % 69
    ds4 e4 fs4 e8. fs16 ) | \barNumberCheck #70
    gs4. ( -> a8 ) -> a4 -> e4 -- | % 71
    c4. -- d8 -- e4 -- b4 | % 72
    gs'4. as,8 bs2 ~ -> | % 73
    R1 | % 74
