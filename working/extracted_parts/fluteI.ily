\version "2.19.83"
% automatically converted by musicxml2ly from fluteI.xml
\pointAndClickOff
...
PartPOneVoiceOne =  \relative cs' {
    ...
    c4. ( -> df8 ) -> df4 -> r4 | % 66
    ff,4. -- gf8 -- af4 -- ef'4 -\f -\markup{ \bold\large\italic
        {pesante} } | % 67
    c4. d8 e2 ~ | % 68
    ...
    | % 93
    b,1*1/2 ( :32 -\ff gs1*1/2 :32 | % 94
    b1*1/2 :32 gs1*1/2 ) :32 | % 95
    b1*1/2 ( :32 gs1*1/2 :32 | % 96
    b1*1/2 :32 gs1*1/2 ) :32 | % 97
    \once \omit TupletBracket
    \times 2/3  {
    ...
    e'2 ( -\markup{ \bold\small\italic {pp espr.} } es2 | % 111
    fs2 f2 | % 112
    e4 ) r4 r2 | % 113
    s1*3 | % 116
    cs'4.. ( -\p d16 e2 ~ | % 117
